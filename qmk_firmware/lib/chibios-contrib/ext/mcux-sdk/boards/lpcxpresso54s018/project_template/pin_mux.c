...
pin_labels:
- {pin_num: K12, pin_signal: PIO1_1/FC3_RXD_SDA_MOSI/CTIMER0_CAP3/SCT0_GPI5/FC10_RXD_SDA_MOSI/USB1_OVERCURRENTN, label: 'J12[12]/U29[4]/SW5/P1_1-USER_PB-USB1_OVRCURn',
  identifier: SW5}
...
- {pin_num: N7, pin_signal: PIO0_23/MCLK/CTIMER1_MAT2/CTIMER3_MAT3/SCT0_OUT4/FC0_CTS_SDA_SSEL0/SPIFI_CSN/ADC0_11, label: 'J13[8]/U27[1]/P0_23-SPIFI_CSn-MCLK', identifier: SPIFI_CSn}
- {pin_num: M13, pin_signal: PIO0_26/FC2_RXD_SDA_MOSI/CLKOUT/CTIMER3_CAP2/SCT0_OUT5/PDM0_CLK/SPIFI_CLK/USB0_IDVALUE/FC10_CTS_SDA_SSEL0, label: 'J13[2]/U27[6]/P0_26-SPIFI_CLK',
  identifier: SPIFI_CLK}
...
- {pin_num: A8, pin_signal: PIO1_30/FC7_TXD_SCL_MISO_WS/SD_D(7)/SCT0_GPI7/USB1_OVERCURRENTN/USB1_LEDN/EMC_D(14), label: 'U28[B1]/RP2[2]/P1_30-EMC_D14', identifier: EMC_D14}
...
- {pin_num: C12, pin_signal: PIO1_14/ENET_RX_DV/UTICK_CAP2/CTIMER1_MAT2/FC5_CTS_SDA_SSEL0/USB0_LEDN/EMC_DQM(1), label: 'U28[F1]/P1_14-EMC_DQM1', identifier: EMC_DQM1}
...
- {pin_num: G1, pin_signal: USB1_IDVALUE, label: 'J2[4]/USB1_ID_TARGET', identifier: USB1_ID}
...
- {pin_num: K10, pin_signal: PIO2_22/LCD_VD(4)/SCT0_OUT7/CTIMER2_CAP0/FC10_RTS_SCL_SSEL1, label: 'J16[9]/P2_22-LCD_VD4', identifier: LCD_VD4}
- {pin_num: M14, pin_signal: PIO2_23/LCD_VD(5)/SCT0_OUT8/FC10_SSEL2, label: 'J16[10]/P2_23-LCD_VD5', identifier: LCD_VD5}
- {pin_num: K14, pin_signal: PIO2_24/LCD_VD(6)/SCT0_OUT9/FC10_SSEL3, label: 'J16[11]/P2_24-LCD_VD6', identifier: LCD_VD6}
...
- {pin_num: M8, pin_signal: PIO2_15/LCD_AC/USB0_LEDN/USB0_OVERCURRENTN/CTIMER0_MAT3/FC5_RTS_SCL_SSEL1, label: 'J16[34]/P2_15-LCD_AC_ENAB_M', identifier: LCD_AC_ENAB_M}
- {pin_num: B14, pin_signal: PIO4_8/ENET_TXD0/FC2_SCK/USB0_OVERCURRENTN/USB0_LEDN/SCT0_GPI1, label: 'U12[17]/JP11[1]/P4_8-ENET_TXD0', identifier: ENET_TXD0}
...
- {pin_num: B9, pin_signal: PIO4_10/ENET_RX_DV/FC2_TXD_SCL_MISO/USB1_OVERCURRENTN/USB1_LEDN/SCT0_GPI3, label: 'U12[11]/P4_10-ENET_CRS_DV', identifier: ENET_CRS_DV}
...
- {pin_num: L14, pin_signal: PIO1_2/CAN0_TD/CTIMER0_MAT3/SCT0_GPI6/PDM1_CLK/FC10_TXD_SCL_MISO/USB1_PORTPWRN, label: 'J13[18]/JS25[3]/DMIC1[4]/P1_2-PDM1_CLK', identifier: PDM1_CLK}
- {pin_num: J13, pin_signal: PIO1_3/CAN0_RD/SCT0_OUT4/PDM1_DATA/USB0_PORTPWRN/FC10_SCK, label: 'JS26[3]/DMIC1[1]/P1_3-PDM1_DATA', identifier: PDM1_DATA}
...
- {pin_num: P10, pin_signal: PIO2_17/LCD_CLKIN/USB1_LEDN/USB1_OVERCURRENTN/CTIMER1_CAP1/FC8_RXD_SDA_MOSI, label: 'J13[20]/P2_17-CT1CAP1-FC8_RXD'}
...
- {pin_num: G3, pin_signal: USB1_AVDDC3V30, label: +3.3V_USB_ENET}
- {pin_num: H1, pin_signal: USB1_AVDDTX3V3, label: +3.3V_USB_ENET}
...
- {pin_num: N11, pin_signal: VBAT0, label: VDD_TARGET}
...
- {pin_num: L6, pin_signal: VDD5, label: VDD_TARGET_IC}
- {pin_num: N6, pin_signal: VDDA, label: VDD_TARGET}
- {pin_num: L11, pin_signal: VDD6, label: VDD_TARGET_IC}
...
- {pin_num: J5, pin_signal: VSS5, label: GND}
...
- pin_list:
  ...
  - {pin_num: K12, peripheral: GPIO, signal: 'PIO1, 1', pin_signal: PIO1_1/FC3_RXD_SDA_MOSI/CTIMER0_CAP3/SCT0_GPI5/FC10_RXD_SDA_MOSI/USB1_OVERCURRENTN, direction: INPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
- options: {prefix: BOARD_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: A13, peripheral: GPIO, signal: 'PIO3, 3', pin_signal: PIO3_3/LCD_VD(17)/FC9_TXD_SCL_MISO, direction: OUTPUT, gpio_init_state: 'true'}
  - {pin_num: C3, peripheral: GPIO, signal: 'PIO2, 2', pin_signal: PIO2_2/ENET_CRS/FC3_SSEL3/SCT0_OUT6/CTIMER1_MAT1, direction: OUTPUT, gpio_init_state: 'true'}
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitPMod_SPI_I2C_BRIDGE
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
/* Function assigned for the Cortex-M4F */
void BOARD_InitPMod_SPI_I2C_BRIDGE(void)
{
    /* Enables the clock for the IOCON block. 0 = Disable; 1 = Enable.: 0x01u */
    CLOCK_EnableClock(kCLOCK_Iocon);
...
- pin_list:
  ...
  - {pin_num: M8, peripheral: LCD, signal: LCD_AC, pin_signal: PIO2_15/LCD_AC/USB0_LEDN/USB0_OVERCURRENTN/CTIMER0_MAT3/FC5_RTS_SCL_SSEL1}
  - {pin_num: K10, peripheral: LCD, signal: 'LCD_VD, 4', pin_signal: PIO2_22/LCD_VD(4)/SCT0_OUT7/CTIMER2_CAP0/FC10_RTS_SCL_SSEL1}
  ...
  - {pin_num: K14, peripheral: LCD, signal: 'LCD_VD, 6', pin_signal: PIO2_24/LCD_VD(6)/SCT0_OUT9/FC10_SSEL3}
  - {pin_num: M14, peripheral: LCD, signal: 'LCD_VD, 5', pin_signal: PIO2_23/LCD_VD(5)/SCT0_OUT8/FC10_SSEL2}
...
void BOARD_InitENET(void)
{
    ...
    GPIO_PinInit(BOARD_INITENET_ENET_PHY_RSTn_GPIO, BOARD_INITENET_ENET_PHY_RSTn_PORT, BOARD_INITENET_ENET_PHY_RSTn_PIN, &ENET_PHY_RSTn_config);
...
- options: {prefix: BOARD_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: L14, peripheral: DMIC0, signal: 'CLK, 1', pin_signal: PIO1_2/CAN0_TD/CTIMER0_MAT3/SCT0_GPI6/PDM1_CLK/FC10_TXD_SCL_MISO/USB1_PORTPWRN}
  - {pin_num: J13, peripheral: DMIC0, signal: 'DATA, 1', pin_signal: PIO1_3/CAN0_RD/SCT0_OUT4/PDM1_DATA/USB0_PORTPWRN/FC10_SCK}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitI2S
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
/* Function assigned for the Cortex-M4F */
void BOARD_InitI2S(void)
{
    /* Enables the clock for the IOCON block. 0 = Disable; 1 = Enable.: 0x01u */
    CLOCK_EnableClock(kCLOCK_Iocon);
