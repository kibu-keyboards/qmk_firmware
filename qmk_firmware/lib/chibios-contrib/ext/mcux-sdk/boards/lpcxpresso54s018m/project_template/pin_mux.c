...
- {pin_num: A13, pin_signal: PIO3_3/LCD_VD(17)/FC9_TXD_SCL_MISO, label: 'U12[12]/P4_16-ENET_MDIO', identifier: ENET_MDIO}
...
- {pin_num: A1, pin_signal: PIO0_1/CAN1_TD/FC3_CTS_SDA_SSEL0/CTIMER0_CAP0/SCT0_GPI1/PDM0_DATA, label: 'J13[4]/U27[2]/P0_25-SPIFI_IO1', identifier: SPIFI_IO1}
...
- {pin_num: A4, pin_signal: VDD7, label: 'U12[13]/P4_15-ENET_MDC', identifier: ENET_MDC}
...
void BOARD_InitLEDs(void)
{
    ...
    gpio_pin_config_t ENET_MDIO_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PIO3_3 (pin A13)  */
    GPIO_PinInit(BOARD_ENET_MDIO_GPIO, BOARD_ENET_MDIO_PORT, BOARD_ENET_MDIO_PIN, &ENET_MDIO_config);
