//*****************************************************************************
// LPC54S018M startup code for use with MCUXpresso IDE
//
// Version : 160420
//*****************************************************************************
//
...
void (* const g_pfnVectors[])(void) = {
    ...
    (void (*)(void))0x001640EF, // mfgId + extCount
    (void (*)(void))0x00000000, // extid 0-3
    (void (*)(void))0x00000000, // reserved
    (void (*)(void))0x1301001D, // caps
    (void (*)(void))0x00000000, // Blks + RESV1
    (void (*)(void))0x00000000, // blkSize
    (void (*)(void))0x00000000, // reserved
    (void (*)(void))0x00000100, // pageSize + RESV2
    (void (*)(void))0x00000000, // maxReadSize
    (void (*)(void))0x00000000, // maxClkRate,maxReadRate,maxHSReadRate,maxProgramRate
