...
#ifndef _LPC54S018M_FEATURES_H_
#define _LPC54S018M_FEATURES_H_
...
/* @brief Has dedicated DMA controller. */
#define FSL_FEATURE_SHA_HAS_MEMADDR_DMA (1)
