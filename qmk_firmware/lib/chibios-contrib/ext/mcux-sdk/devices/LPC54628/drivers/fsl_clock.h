...
#define CM_MAINCLKSELA 0U
#define CM_MAINCLKSELB 1U
#define CM_CLKOUTCLKSELA 2U
#define CM_SYSPLLCLKSEL 4U
#define CM_AUDPLLCLKSEL 6U
#define CM_SPIFICLKSEL 8U
#define CM_ADCASYNCCLKSEL 9U
#define CM_USB0CLKSEL 10U
#define CM_USB1CLKSEL 11U
#define CM_FXCOMCLKSEL0 12U
#define CM_FXCOMCLKSEL1 13U
#define CM_FXCOMCLKSEL2 14U
#define CM_FXCOMCLKSEL3 15U
#define CM_FXCOMCLKSEL4 16U
#define CM_FXCOMCLKSEL5 17U
#define CM_FXCOMCLKSEL6 18U
#define CM_FXCOMCLKSEL7 19U
#define CM_FXCOMCLKSEL8 20U
#define CM_FXCOMCLKSEL9 21U
#define CM_MCLKCLKSEL 24U
#define CM_FRGCLKSEL 26U
#define CM_DMICCLKSEL 27U
#define CM_SCTCLKSEL 28U
#define CM_LCDCLKSEL 29U
#define CM_SDIOCLKSEL 30U
...
static inline void CLOCK_EnableClock(clock_ip_name_t clk)
{
    ...
    {
        SYSCON->ASYNCAPBCTRL             = SYSCON_ASYNCAPBCTRL_ENABLE(1U);
...
{
    kCLOCK_Flash1Cycle = 0U, /*!< Flash accesses use 1 CPU clocks */
...
static inline void CLOCK_SetFLASHAccessCycles(clock_flashtim_t clks)
{
    ...
    tmp32 = SYSCON->FLASHCFG & ~(SYSCON_FLASHCFG_FLASHTIM_MASK);

    /* Don't alter lower bits */
    SYSCON->FLASHCFG = tmp32 | ((uint32_t)clks << SYSCON_FLASHCFG_FLASHTIM_SHIFT);
}
...
{
    uint32_t tmp32 = ASYNC_SYSCON->ASYNCAPBCLKSELA & 0x3UL;
    return (async_clock_src_t)tmp32;
}
...
{
    return (SYSCON->USBPLLSTAT & SYSCON_USBPLLSTAT_LOCK_MASK) != 0UL;
}
...
{
    return (SYSCON->AUDPLLSTAT & SYSCON_AUDPLLSTAT_LOCK_MASK) != 0UL;
}
...
#define PLL_CONFIGFLAG_FORCENOFRACT                                                                                   \
    (1UL                                                                                                              \
     << 2U) /*!< Force non-fractional output mode, PLL output will not use the fractional, automatic bandwidth, or SS \
            \ \                                                                                                       \
              \ \ \ \                                                                                                 \
                 \ \ \ \ \ \                                                                                          \
                   \ \ \ \ \ \ \ \                                                                                    \
...
#define PLL_SETUPFLAG_WAITLOCK (1UL << 1U) /*!< Setup will wait for PLL lock, implies the PLL will be pwoered on */
