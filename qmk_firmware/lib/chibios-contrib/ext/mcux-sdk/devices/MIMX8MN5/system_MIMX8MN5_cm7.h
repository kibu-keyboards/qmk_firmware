 ...
 * @version 2.0
 * @date 2019-09-23
 * @brief Device specific configuration file for MIMX8MN5_cm7 (header file)
 *
...
#ifndef _SYSTEM_MIMX8MN5_cm7_H_
#define _SYSTEM_MIMX8MN5_cm7_H_ /**< Symbol preventing repeated inclusion */
