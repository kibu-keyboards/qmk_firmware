...
#define SIM_CLKDIV1_OUTDIV3_VAL ((uint32_t)(SIM->CLKDIV1 & SIM_CLKDIV1_OUTDIV3_MASK) >> SIM_CLKDIV1_OUTDIV3_SHIFT)
...
uint32_t CLOCK_GetFreq(clock_name_t clockName)
{
    ...
    switch (clockName)
    {
        ...
        case kCLOCK_FlexBusClk:
            freq = CLOCK_GetOutClkFreq() / ((uint32_t)(SIM_CLKDIV1_OUTDIV3_VAL + 1UL));
            break;
