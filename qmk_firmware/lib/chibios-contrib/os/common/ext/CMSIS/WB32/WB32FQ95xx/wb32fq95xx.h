...
/** @addtogroup wb32fq95xx
  * @{
  */

#ifndef __WB32FQ95xx_H__
#define __WB32FQ95xx_H__
...
/**
 * @brief WB32FQ95xx Standard Peripheral Library version number
 */
#define __WB32FQ95xx_STDPERIPH_VERSION_MAIN   (0x00) /*!< [31:24] main version */
#define __WB32FQ95xx_STDPERIPH_VERSION_SUB1   (0x01) /*!< [23:16] sub1 version */
#define __WB32FQ95xx_STDPERIPH_VERSION_SUB2   (0x05) /*!< [15:8]  sub2 version */
#define __WB32FQ95xx_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */
#define __WB32FQ95xx_STDPERIPH_VERSION        ( (__WB32FQ95xx_STDPERIPH_VERSION_MAIN << 24) \
                                               |(__WB32FQ95xx_STDPERIPH_VERSION_SUB1 << 16) \
                                               |(__WB32FQ95xx_STDPERIPH_VERSION_SUB2 << 8) \
                                               |(__WB32FQ95xx_STDPERIPH_VERSION_RC))
...
/* ----------------------  WB32FQ95xx Specific Interrupt Numbers  --------------------- */
...
#define __MPU_PRESENT             1         /* WB32FQ95xx devices provide an MPU */
